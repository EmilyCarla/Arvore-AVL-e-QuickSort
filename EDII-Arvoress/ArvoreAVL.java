...
public class ArvoreAVL {
    ...
    public void printInOrder() {
        System.out.print("Dados em ordem: ");
    ...
    public static void main(String[] args) {
        ...
        for (long value : inputData) {
            avlTree.insert(value);
        }

        // Medir o tempo para imprimir os dados em ordem
        long startTime = System.currentTimeMillis();
        avlTree.printInOrder();
        long endTime = System.currentTimeMillis();

        // Calcular a diferença de tempo em segundos e milissegundos
        long elapsedTime = endTime - startTime;
        long seconds = elapsedTime / 1000;
        long milliseconds = elapsedTime % 1000;

        System.out.println("Tempo para imprimir os dados: " + seconds + " segundos e " + milliseconds + " milissegundos");
    }
}
